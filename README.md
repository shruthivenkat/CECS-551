...
Design a decision tree based explainable model and provide an explanatory interface 
Compute the fairness of the model  
Perform a what-if analysis using CeterisParibus on the given dataset
